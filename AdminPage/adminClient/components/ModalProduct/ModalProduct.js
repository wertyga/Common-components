...
export default class ModalProduct extends React.Component {
    ...
    submitData = () => {
        ...
        form.append('category', this.state.categoryChosen);
        form.append('price', this.state.price);
        form.append('discount', this.state.discount);
        form.append('image', this.productImage || this.state.image);
        if(this.state.oldCategory) form.append('oldCategory', this.state.oldCategory);
    ...
    deleteProduct = () => {
        this.props.deleteProduct({
            ...
            category: this.state.oldCategory
        });
        this.props.onClose();
    };
